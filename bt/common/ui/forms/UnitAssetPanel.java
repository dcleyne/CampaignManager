...
import bt.common.ui.models.AssetTableModel;
import bt.common.ui.models.TableSorter;
import bt.common.util.SwingHelper;
import bt.servermanager.ui.forms.AddElementsDialog;
...
public class UnitAssetPanel extends JPanel implements ClosableEditForm, MouseListener, ActionListener
{
    ...
    public UnitAssetPanel(Unit u)
    {
        ...
        m_EditPanel.add(SwingHelper.GetTextFieldWithAction(m_ConditionTextField, "Condition", "The condition of this Asset",true,"AssetCondition","Check the condition of the Asset",this));
    ...
    public void mouseClicked(MouseEvent me)
    {
        ...
        m_CurrentAsset = m_Unit.getAssets().elementAt(Index);
    ...
    private void ShowAssetCondition()
    {
        if (m_CurrentAsset == null)
        {
            JOptionPane.showMessageDialog(this,"Select an Asset record or add a new Record!","Viewing Asset Condition",JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        
        ElementType et = m_CurrentAsset.getElementType();
        Frame owner = JOptionPane.getFrameForComponent(this);

        switch (et)
        {
        case BATTLEMECH:
        	BattlemechStatusDialog dlg = new BattlemechStatusDialog(owner,(Battlemech)m_CurrentAsset);
