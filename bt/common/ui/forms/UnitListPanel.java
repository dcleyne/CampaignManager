...
import bt.common.ui.models.UnitTableModel;
...
public class UnitListPanel extends JPanel implements ListSelectionListener, MouseListener
{
    ...
    public UnitListPanel(Vector<UnitSummary> units)
    {
    	m_Units = units;
    ...
    public void requestUnitEdit(String unitName)
    {
    	for (UnitChangeListener l : _EditRequestListeners)
    		l.requestUnitEdit(unitName);
    }

    public UnitSummary GetSelectedUnit()
    {
