...
import bt.common.ui.models.PersonnelTableModel;
...
public class UnitPersonnelPanel extends JPanel implements ClosableEditForm, MouseListener, ActionListener
{
    ...
    protected JTextField m_SurnameTextField = new JTextField();
    ...
    public UnitPersonnelPanel(Unit u)
    {
        ...
        m_EditPanel.add(SwingHelper.GetTextFieldWithAction(m_NameTextField, "Name", "First name of the Unit member",true,"RandomName","Generate a Random Name",this));
        m_EditPanel.add(SwingHelper.GetTextField(m_SurnameTextField, "Surname", "The Person's surname",true));
    ...
    protected void SetFields()
    {
        if (m_CurrentPersonnel != null)
        {
            ...
            m_SurnameTextField.setText(m_CurrentPersonnel.getSurname());
    ...
    protected void GetFields()
    {
        ...
        m_PreviousPersonnel.setSurname(m_SurnameTextField.getText());
