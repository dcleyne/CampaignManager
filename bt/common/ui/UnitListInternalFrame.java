...
import bt.common.ui.forms.UnitListPanel;
import bt.common.ui.listeners.UnitChangeListener;

public class UnitListInternalFrame extends JInternalFrame implements ActionListener
{
    ...
    public UnitListInternalFrame(String Title, Vector<UnitSummary> units, UnitChangeListener ucl)
    {
...
//            SwingUtilities.invokeLater(new factorymanager.database.data.managers.UnitEditRequestor(a));
        ...
        {
            UnitSummary a = m_UnitListPanel.GetSelectedUnit();
            if (a != null)
            {
                ...
                {
                    //TODO 
                	// UnitCache.getInstance().deleteUnit(a.getName());
                }
            }
        }
        if (e.getActionCommand() == "Edit")
        {
            ...
            if (a != null)
            {
                m_UnitListPanel.requestUnitEdit(a.getUnitName());
            }
        }
    }
