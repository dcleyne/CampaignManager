...
import bt.common.elements.personnel.Administrator;
import bt.common.elements.personnel.Astech;
import bt.common.elements.personnel.JobType;
import bt.common.elements.personnel.Mechwarrior;
import bt.common.elements.personnel.Medic;
...
import bt.common.elements.personnel.Technician;
import bt.common.elements.unit.MechAvailability;
...
import bt.common.util.ExtensionFileFilter;
...
public class UnitManager
{
	...
	{
		String fileName = PropertyUtil.getStringProperty("DataPath", "bt/data/") + "RandomMechUnitParameters.xml";
	...
	public void saveUnitSummaries(Vector<Unit> units) throws Exception
	{
		...
		String fileName = PropertyUtil.getStringProperty("DataPath", "bt/data/") + "/units/UnitSummaries.xml";
		XMLOutputter out = new XMLOutputter(Format.getPrettyFormat());
		out.output(doc, new FileOutputStream(fileName));
	}
	...
	{
		String fileName = PropertyUtil.getStringProperty("DataPath", "bt/data/") + "/Units/" + u.getName() + ".xml";
	...
	public Unit loadUnitFromElement(org.jdom.Element unitNode)
	{
		...
		while (iter.hasNext())
		{
			...
			u.getBattlemechs().add(bm.loadBattlemech(mechElement));
		}
		...
		org.jdom.Element assignedMissionsElement = unitNode.getChild("AssignedMissions");
		if (assignedMissionsElement != null)
		{
			iter = assignedMissionsElement.getChildren("Mission").iterator();
			while (iter.hasNext())
			{
	...
	{
		String dataPath = PropertyUtil.getStringProperty("DataPath", "bt/data/") + "units/";
	...
	{
		String filename = PropertyUtil.getStringProperty("DataPath", "bt/data/") + "Units/" + unitName + ".xml";
		try
		{
