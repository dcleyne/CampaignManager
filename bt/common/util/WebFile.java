...
public final class WebFile 
{
    ...
    public static String getWebPageContent(String url, String proxyAddress, int proxyPort)
    {
    	...
    	{
    		return ExceptionUtil.getExceptionStackTrace(ex);    		
    	}
	    return "";
    }
    ...
    public WebFile( String urlString , String proxyAddress, int proxyPort)
        ...
        final java.net.URLConnection uconn;
        if (!proxyAddress.isEmpty())
        {
        	proxy = new java.net.Proxy(java.net.Proxy.Type.HTTP, new java.net.Socket(proxyAddress,proxyPort).getRemoteSocketAddress());
