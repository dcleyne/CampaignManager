...
import bt.client.ui.mapping.planetmap.WorldMap;
...
public class PlanetMapGenerator 
{
	...
	public void generatePlanetMap(InnerSpherePlanet planet, SolarSystemDetails ssd, boolean forceCreate, boolean compress)	
	{
		...
		ssd.generateRandomPlanet(true, true, true);
		
		log.info("Storing Map for " + planet.toString());
		SolarSystemManager.getInstance().saveSolarSystemDetails(planet.getID(), planet.getSystem(), ssd, compress);
